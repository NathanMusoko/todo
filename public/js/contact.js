...
const validateAge = () => {
    if(inputAge.validity.valid) {
        ...
        errorAge.innerText = 'La valeur doit être plus grande que 0';
        errorAge.style.display = 'block';
    }
    else if(inputAge.validity.rangeOverflow) {
        errorAge.innerText = 'La valeur ne doit pas dépasser 150';
        errorAge.style.display = 'block';
    }
}
...
const validateMessage = () => {
    if(inputMessage.validity.valid) {
        ...
        errorMessage.innerText = 'Le message doit avoir au maximum 500 caractères';
        errorMessage.style.display = 'block';
    }
}
